<div class="ws-wrap ml-auto mr-auto">
    <p class="ws_breadcrumb mt-4">영상마당 / 말씀영상 / 1분성경 </p>
    ...
    <div class="flex flex-between mt-10" data-aos="zoom-out">
        <h1 class="ws_title">추천영상</h1>
        <span class="ws_more_btn">더보기 ></span>
    </div>
    <div class="layout cols-4 mt-3" data-aos="zoom-out" data-aos-delay="300">
        <?php for($i=0;$i<4;$i++){?>
        <div class="col">
    ...
    <div class="layout cols-4 mt-3 mb-16" data-aos="zoom-out" data-aos-delay="300">
        <?php for($i=0;$i<4;$i++){?>
        <div class="col">
            <figure class="thumbnail ws_mask">
                <img src="<?=BASE_URL?>dist/img/thumbnail1.png">
